...
print('MBTI Personality Distribution \n')
...
for word in all_pers:
  ...
  pers_perc[word]=perc
#print(pers_perc)
#print('kuldeepnaryanminj')
#print('==================================')
#result1 = np.prod([char_per[el] for el in word])
#print(result1)
#print('==================================')
#result2 = np.prod(char_per)
#print(result2)
#print('==================================')
for word in all_pers:
  perc=np.prod([char_per[el] for el in word])/1000000
  pers_perc[word]=perc
print(pers_perc)
...
ThreeHighest = nlargest(3, pers_perc, key = pers_perc.get) 
print('User Name - ' + username + '\n')
print("Top 3 personalities are:") 
print("Type: Percentage") 
  
for val in ThreeHighest: 
    print(val, ":",pers_perc.get(val),"%") 
